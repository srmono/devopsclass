...
```
az group create -l westeurope -n itgurukulK8sResourceGroup
az storage account create -n itgurukulK8sStorageAccount -g itgurukulK8sResourceGroup -l westeurope --sku Standard_LRS
